-- Inserir Clientes
INSERT INTO TB_CLIENT (NAME, CPF, INCOME, SEXO, EMAIL, BIRTH_DATE, SENHA) VALUES ('JOSE EUSTAQUIO', '936.909.604-36', 1600.0, 'M', 'jose@exemplo.com', TIMESTAMP WITH TIME ZONE '1985-01-10T20:50:07.12345Z', '$2a$10$qGMvT3AvtGNJeZEhCEkkSuHQ3iXRkLlIxcdifuP918K0aXK243Bla');
...
INSERT INTO TB_CLIENT (NAME, CPF, INCOME, SEXO, EMAIL, BIRTH_DATE, SENHA) VALUES ('VANESSA AMORUIM', '2967.930.204-04', 7350.00, 'F', 'keryda@exemplo.com', TIMESTAMP WITH TIME ZONE '1990-01-31T10:19:08.12345Z', '$2a$10$qGMvT3AvtGNJeZEhCEkkSuHQ3iXRkLlIxcdifuP918K0aXK243Bla');
...
-- Vendas
INSERT INTO TB_VENDAS (COD_PRD, COD_CLI, QTD, DATA_VENDA, TOTAL, PRC_UNITARIO) 
VALUES (1, 1, 2, TIMESTAMP WITH TIME ZONE '2024-01-10', 8500.0, 4250.0);
INSERT INTO TB_VENDAS (COD_PRD, COD_CLI, QTD, DATA_VENDA, TOTAL, PRC_UNITARIO) 
VALUES (2, 1, 3, TIMESTAMP WITH TIME ZONE '2024-01-25', 11550.0, 3850.0);
INSERT INTO TB_VENDAS (COD_PRD, COD_CLI, QTD, DATA_VENDA, TOTAL, PRC_UNITARIO) 
VALUES (3, 1, 1, TIMESTAMP WITH TIME ZONE '2024-02-05', 4500.0, 4500.0);
INSERT INTO TB_VENDAS (COD_PRD, COD_CLI, QTD, DATA_VENDA, TOTAL, PRC_UNITARIO) 
VALUES (4, 1, 4, TIMESTAMP WITH TIME ZONE '2024-03-01', 6000.0, 1500.0);
INSERT INTO TB_VENDAS (COD_PRD, COD_CLI, QTD, DATA_VENDA, TOTAL, PRC_UNITARIO) 
VALUES (5, 12, 1, TIMESTAMP WITH TIME ZONE '2024-03-20', 1870.0, 1870.0);
INSERT INTO TB_VENDAS (COD_PRD, COD_CLI, QTD, DATA_VENDA, TOTAL, PRC_UNITARIO) 
VALUES (6, 12, 2, TIMESTAMP WITH TIME ZONE '2024-03-30', 2640.0, 5280.0);
